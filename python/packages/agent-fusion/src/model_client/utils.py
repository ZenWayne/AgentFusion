...
from dataclass.model_info import model_list, ModelClientConfig
import os
from dotenv import load_dotenv

ModelClient : dict[str, OpenAIChatCompletionClient] = {}
...
def create_model_clients(dotenv_path:str)->Dict[str, OpenAIChatCompletionClient]:
    ...
    for k, config in configs.items():
        model_client = model_client_builder(
            label=config.label,
